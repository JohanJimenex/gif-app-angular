...
export interface IObjtResponse {
  data: IGif[];
...
export class Convert {
  public static toObjtResponse(json: string): IObjtResponse {
    return cast(JSON.parse(json), r("IObjtResponse"));
  }

  public static objtResponseToJson(value: IObjtResponse): string {
    return JSON.stringify(uncast(value, r("IObjtResponse")), null, 2);
  }
}
...
const typeMap: any = {
  "IObjtResponse": o([
    { json: "data", js: "data", typ: a(r("IGif")) },
